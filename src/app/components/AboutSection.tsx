...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-black sm:mt-0 mt-20 px-4 py-8 md:py-16 text-cyan-400 relative"
      id="about"
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center md:justify-between mt-0">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-1xl text-white font-semibold leading-relaxed mb-4 lg:mr-40 lg:left-[40%] mt-10">
            Hi! I&#39;m Areeba Tanveer Awan, a passionate web developer with skills in HTML, CSS, JavaScript, TypeScript, Next.js, and Tailwind CSS. Currently a GIAIC  student pursuing an Artificial Intelligence, I&#39;m dedicated to mastering the art of web development. I&#39;m always eager to learn, grow, and take on new challenges in this field.
          </p>
